...
// Stub implementation for Bitget (Crypto)
export class BitgetBroker implements BrokerInterface {
	name = 'bitget';
	private connected = false;

	async connect(credentials: BrokerCredentials): Promise<boolean> {
		// TODO: Implement Bitget API connection
		console.warn('Bitget broker not yet implemented');
		return false;
	}
	...
	async getAccountInfo(): Promise<AccountInfo> {
		throw new Error('Bitget broker not yet implemented');
	}
