...
<svelte:head>
	<title>Connexion - BaconAlgo 2040</title>
</svelte:head>
	...
	<div class="w-full max-w-md">
		<div class="glass-panel p-8">
			<div class="text-center mb-8">
				...
				<p class="text-gray-400">Système de Trading Neural 2040</p>
			</div>
			...
			<p class="mt-6 text-center text-sm text-gray-400">
				...
				<a href="/auth/register" class="text-bacon-orange hover:text-bacon-accent font-medium">
					S'inscrire
				</a>
			</p>
		</div>
